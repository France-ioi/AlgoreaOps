...
aws lambda publish-version --region eu-central-1 --function-name AlgoreaBackend --description "Autodeployment ${DEPLOYMT_NUM} (v${VERSION} on env ${DEPLOYED_ENV})" ${AWS_EXTRA_ARGS} | yq '.Version'
